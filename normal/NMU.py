...
"""
python3 experiments/simple_function_static.py --operation mul --layer-type ReRegualizedLinearNAC --nac-mul mnac --seed 0 --max-iterations 5000000 --verbose --name-prefix test --remove-existing-data
"""
